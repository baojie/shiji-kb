...
原始11类（v1.0）+ 2026-03-13扩展4类（v1.1）+ 2026-03-13迁移为〖〗格式（v2.0）+ 封国类型（v2.1）。
...
*本SKILL文档基于《史记》130篇×57万字的实体标注实践（2025-02 至 2026-03）提炼。v1.1（2026-03-13）扩展为15类实体（+典籍/礼仪/刑法/思想），v2.0（2026-03-13）迁移为〖〗格式（官职符号`$`→`;`），v2.2（2026-03-14）实体清理重构（朝代→邦国`〖'〗`+氏族`〖&〗`+身份`〖#〗`，外邦归族群，官职/地名多轮反思，~8,500处修正）。*
*实际投入：~120小时人工 + ~30亿Token AI处理，产出11,731个实体、97,069次标注。*

...
*本SKILL文档基于《史记》130篇×57万字的实体标注实践（2025-02 至 2026-03）提炼。v1.1（2026-03-13）扩展为15类实体（+典籍/礼仪/刑法/思想），v2.0（2026-03-13）迁移为〖〗格式（官职符号`$`→`;`），v2.2（2026-03-14）重构为16类（朝代→邦国`〖'〗`+氏族`〖&〗`，外邦归族群）。*
*实际投入：~70小时人工 + ~5.7亿Token AI处理，产出11,786个实体、94,894次标注。*

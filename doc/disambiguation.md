...
841 BCE 之前的年代来自夏商周断代工程（2000年发布）的官方年表：
...
当年份超出已匹配君主的在位范围时（多为连续归因跨越君主更替），
自动在同国君主序列中查找正确归属，恢复公元纪年映射。
...
共提取380位君主（含断代工程补充的pre-841 BCE君主）、32个汉代年号。
...
| 指标 | 人名消歧 | 年份消歧 |
|------|----------|----------|
| 数据源 | 全文扫描+人工规则 | 年表章节(014/015/022) + 夏商周断代工程 |
| 覆盖范围 | 130篇全文 | 71篇（排除年表） |
| 映射数量 | ~3000条/章 | 1498条（573个公元年+79个君主纪年） |
| 公元覆盖 | — | 前1248年～前91年（含断代工程推算） |
| 未解决率 | 低 | ~7%（保守策略） |

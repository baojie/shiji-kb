...
本文档验证 `lint_markdown.py` 和 `lint_html.py` 是否完整覆盖了 [标注格式规范.md](标注格式规范.md) 中定义的所有格式规范。
...
| 规范项 | 标注格式规范.md要求 | lint_markdown.py检查 | 覆盖状态 |
|--------|----------------------------|---------------------|---------|
| **文件结构** | | | |
...
| 规范项 | 标注格式规范.md要求 | lint_html.py检查 | 覆盖状态 |
|--------|----------------------------|-----------------|---------|
| **HTML结构** | | | |
...
**最后更新**: 2026-02-08
**相关文档**:
- [标注格式规范.md](标注格式规范.md) - 格式规范
- [校验工具使用指南.md](校验工具使用指南.md) - 使用指南

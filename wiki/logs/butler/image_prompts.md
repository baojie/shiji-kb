...
待生成 AI 图片的页面列表。Butler 执行 gen-image-prompt 时追加，人工确认后生成并填写图片路径。

- [x] [[袁盎]] (person) — 袁盎
  prompt: Portrait of Yuan Ang Han official (袁盎), ancient Chinese historical figure. ancient Chinese ink painting, Song dynasty style, fine brushwork, traditional, dignified pose, official robes or armor appropriate to period, neutral background, high quality, museum artwork. Context: [[袁盎]]（字丝，约前 215 — 前 148），汉文景时代**最敢直谏的臣子**。
  added: 2026-04-25
- [x] [[二世皇帝]] (person) — 二世皇帝

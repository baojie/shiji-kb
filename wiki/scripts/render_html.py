...
<link rel="icon" type="image/svg+xml" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'%3E%3Crect width='64' height='64' rx='10' fill='%237a1f1f'/%3E%3Ctext x='50%25' y='53%25' dominant-baseline='middle' text-anchor='middle' font-family='serif' font-size='46' fill='%23faf8f0' font-weight='bold'%3E史%3C/text%3E%3C/svg%3E">
<style>{css}</style>
</head>
<body>
<nav class="topnav">

...
文本中使用以下标注符号（v2.2，16类，2026-03-14）：
...
详见：[第一轮总结](../doc/events/第一轮事件年代反思总结.md) · [第二轮总结](../doc/events/第二轮事件年代反思总结.md) · [第三轮总结](../doc/events/第三轮事件年代反思总结.md) · [第四轮总结](../doc/events/第四轮事件年代反思总结.md) · [第五轮总结](../doc/events/第五轮事件年代反思总结.md) · [SKILL文档](../SKILL_事件年代推断.md)
...
# → 输出：docs/entities/*.html（16类实体 + event.html事件时间索引 + index.html总览）

...
| 105-002 | 扁鹊诊赵简子 | 文化活动 | @晋昭公@时 [约公元前500年] | - | @扁鹊@、@赵简子@、@董安于@ | &晋& |
...
- **原文引用**: "@扁鹊@曰：'血脉治也，而何怪！昔@秦穆公@尝如此，%七日%而寤。'""@简子@赐@扁鹊@田%四万%亩。"
- **段落位置**: [1.2]
- **年代推断**: 赵简子（赵鞅）活跃于晋定公时期，年表前497年记载赵鞅杀邯郸午、前496年赵鞅杀董安于，前476年左右卒。前386年是田氏代齐之年，远晚于赵简子时代。原文虽称'晋昭公之时'（前531-前526），但赵简子专国事应在晋定公时期（约前512-前475），约前500年较合理。另注：原年代推断称'赵简子卒于前476年'是正确的，但标注前386年明显错误。
...
- **原文引用**: "疾之居腠理也，汤熨之所及也；在血脉，针石之所及也；其在肠胃，酒醪之所及也；其在骨髓，虽司命无柰之何。"
- **段落位置**: [1.4]
- **年代推断**: 年表前357年明确记载'（田）齐桓公死，在位十八年'。齐桓侯即田齐桓公午（前374-前357年在位），此事发生在其末年死前。年表有载，应升级为精确纪年。但须注意：若采纳105-002修正为约前500年，则扁鹊活跃期从前500年到前357年跨143年，与常人寿命不符，印证了学界'扁鹊非一人'的观点。按现有索引的做法（将文本中的扁鹊视为同一叙事主体），保留前357年是合理的。
...
- **原文引用**: "诏问故$太仓长$臣@意@：'方伎所长，及所能治病者？有其书无有？皆安受学？受学几何岁？'"
- **段落位置**: [2.3]
- **年代推断**: 诏问与缇萦上书为同一事件的延续，年表前167年条明确记载'齐太仓令淳于意有罪。女缇萦上书愿代父受刑。文帝诏废肉刑'。诏问病案是文帝召淳于意问诊的直接结果，应升级为精确纪年。确定性标注不足（错误7）。
...
- **原文引用**: "=临菑=人@宋邑@。@邑@学，臣@意@教以五诊，%岁馀%。@济北王@遣$太医$@高期@、@王禹@学，臣@意@教以经脉高下及奇络结"
- **段落位置**: [4.6]
- **年代推断**: 此为淳于意应诏问时述及弟子传承情况，是诏问事件的组成部分。年表前167年已确认此事，应升级为精确纪年。确定性标注不足（错误7）。

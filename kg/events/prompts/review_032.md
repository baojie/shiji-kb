...
| 032-026 | 崔杼灭族自杀 | 政治整顿 | %元年% （公元前547年） | =齐= | @崔杼@、@庆封@ | &齐& |
| 032-027 | 太史书崔杼弑君 | 文化活动 | [约公元前548年] | =齐= | @崔杼@ | &齐& |
| 032-028 | 鞍之战齐败于晋 | 战争 | %十年春% （公元前589年） | =鞍= | @齐顷公@、@郤克@、@逄丑父@ | &齐&、&晋& |
| 032-029 | 晏婴谏彗星 | 政治活动 | %三十二年% （公元前516年） | =柏寝= | @景公@、@晏婴@ | &齐& |
| 032-030 | 夹谷之会 | 政治活动 | %四十八年% （公元前500年） | =夹谷= | @景公@、@鲁定公@、@孔丘@ | &齐&、&鲁& |
| 032-031 | 田乞立悼公 | 继位 | 公元前489年 | =齐= | @田乞@、@阳生@（@悼公@） | &齐& |
...
- **原文引用**: "@宋襄公@率诸侯兵送=齐=$太子$@昭@而伐=齐=。...&宋&败=齐=四$公子$师而立$太子$@昭@，是为@齐孝公@。"
- **段落位置**: [44]
- **年代推断**: 年表前642年条明确记载'宋人立孝公。是年为齐孝公元年'。齐桓公四十三年卒于前643年，无诡立后宋襄公率诸侯伐齐立太子昭为孝公，当在前642年。前632年为晋文公城濮之战之年，与齐孝公即位无关。原标注偏差10年，疑为将齐孝公元年与晋文公称霸年份混淆。
...
- **原文引用**: "=齐=$太史$书曰'@崔杼@弑@庄公@'，@崔杼@杀之。其弟复书，@崔杼@复杀之。少弟复书，@崔杼@乃舍之。"
- **段落位置**: [61]
- **年代推断**: 太史书'崔杼弑庄公'一事紧接崔杼弑庄公（前548年）之后发生，是崔杼弑君当时或紧随其后的事件，应标注为前548年左右。前547年是景公元年，崔杼灭族之年，太史秉笔直书应发生在弑君事件刚发生时（前548年），而非一年后。
...
- **原文引用**: "%庚辰%，@田常@执@简公@于=袪州=。...%甲午%，@田常@弑@简公@于=袪州=。@田常@乃立@简公@弟@骜@，是为@平公@。...专=齐=之政。"
- **段落位置**: [76]
- **年代推断**: 年表前481年条明确记载'齐简公四年，简公任用阚止（监止，子我），谋逐田（陈）氏。田常（陈恒）杀阚止及简公，立简公弟平公骜。'前485年是悼公四年（田乞杀悼公、立简公之年），并非简公四年。简公元年=前484年，简公四年=484-(4-1)=前481年。原标注将悼公被杀之年（前485年）错误对应到简公四年的纪年标记，属于错误4（年号/帝王混淆）的变体——将前一任君主的纪年终点误作后一任君主的reign-year基准。
...
| 032-004 | 太公治齐通商工 | 政治改革 | [约公元前1046年] | =齐= | @太公@ | &齐& |
| 032-005 | 周天子赐征伐权 | 政治活动 | [约公元前1042年] | =齐= | @太公@、@召康公@ | &周&、&齐& |
| 032-006 | 纪侯谮哀公被烹 | 政治整顿 | [约公元前890年] | - | @哀公@、@纪侯@ | &齐&、&周& |
...
- **原文引用**: "@哀公@时，@纪侯@谮之&周&，&周&烹@哀公@而立其弟@静@，是为@胡公@。"
- **段落位置**: [10]
- **年代推断**: 哀公被烹后立胡公，原文记胡公'当周夷王之时'。年表显示周夷王在位期为前885-前878年，故哀公被烹应在夷王之前或夷王初年，约前890年。现标前868年属周厉王时期（前877-前841年），偏晚约20年。
...
- **文化活动**: 2
- **建设**: 2
- **年代推断**： 年份正确（年表前379年条确认'齐康公死，在位二十六年'），但有两个格式问题：(1)详情section缺少段落位置行和年代推断行；(2)年代推断行'原文记载二十六年，即公元前379年'被错误放置到统计信息区域（文件第431行），属于错误模式23（年代推断行位置错位至非事件区域）。需将年代推断行移回032-034详情section。

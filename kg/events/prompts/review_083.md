...
你的任务是审查并修正《史记》083_鲁仲连邹阳列传的事件索引中的年代标注。
...
1. **事件索引**（待审查和修改）：`kg/events/data/083_鲁仲连邹阳列传_事件索引.md`
...
### 第三步：读取事件索引
完整读取 `kg/events/data/083_鲁仲连邹阳列传_事件索引.md`，统计事件总数，识别锚点分布（有多少个精确纪年事件、推断纪年事件、无纪年事件）。
...
- **Claude反思修正**：在 001, 003, 004, 005, 010, 009, 008, 002, 013, 015, 014, 012, 011, 026, 017, 023, 024, 025, 019, 037, 027, 028, 029, 041, 042, 043, 044, 045, 046, 047, 049, 050, 052, 053, 055, 056, 057, 058, 059, 060, 061, 062, 063, 064, 065, 071, 111, 032, 073, 076, 030, 034, 109, 077, 079, 081, 082 中出现
...
| 083-005 | 聊城书谏 | 政治活动 | %二十馀年后% [约公元前249年] | =聊城= | @鲁仲连@、@田单@ | &齐&、&燕& |
...
- **段落位置**: [2.1]-[2.5]
- **年代推断**: 据《中国历史大事年表》，前258年秦昭王四十九年，王陵攻邯郸，魏遣新垣衍说赵尊秦为帝，鲁仲连驳之
...
- **段落位置**: [8.2]-[8.3]
- **年代推断**: 据《中国历史大事年表》，前257年信陵君在邯郸城下大破秦军
...
- **段落位置**: [10.1]-[10.6]
- **年代推断**: 原文"其後二十馀年"，以邯郸解围(前257年)推算约在前249年前后
...
| 083-003 | 秦军退邯郸解围 | 战争 | （公元前257年） | =邯郸= | @鲁仲连@、@无忌@ | &赵&、&秦&、&魏& |
| 083-004 | 鲁仲连辞封不受 | 政治活动 | [公元前257年] | - | @鲁仲连@、$平原君$ | &赵& |
| 083-005 | 聊城书谏 | 政治活动 | %二十馀年后% [约公元前237年] | =聊城= | @鲁仲连@、@田单@ | &齐&、&燕& |
| 083-006 | 燕将自杀聊城陷 | 战争 | [约公元前237年] | =聊城= | @田单@ | &齐&、&燕& |
| 083-007 | 鲁仲连再辞爵禄 | 政治活动 | [约公元前237年] | - | @鲁仲连@ | &齐& |
| 083-008 | 邹阳下狱 | 政治活动 | [约公元前148年] | - | @邹阳@、@羊胜@、@公孙诡@、$孝王$ | &梁& |
| 083-009 | 邹阳狱中上书 | 文化活动 | [约公元前148年] | - | @邹阳@、$孝王$ | &梁& |
...
- **原文引用**: "@鲁连@乃为书，约之矢以射城中，遗&燕&将。"
- **段落位置**: [10.1]-[10.6]
- **年代推断**: 原文'其後二十馀年'从邯郸解围(前257年)推算，257-20=237，约前237年。当前标注前249年仅距前257年8年，与'二十馀年'严重不符。但须注意：田单前279年复齐、前264年为齐相，前237年时田单可能已故，此处存在史料争议。按原文字面推算应为约前237年
...
- **原文引用**: "&燕&将见@鲁连@书，泣%三日%，犹豫不能自决……喟然叹曰：'与人刃我，宁自刃。'乃自杀。"
- **段落位置**: [11.1]-[11.5]
- **年代推断**: 紧接083-005聊城书谏之后，应与之同年。从'其後二十馀年'推算，约前237年
...
- **原文引用**: "@鲁连@逃隐於=海=上，曰：'吾与富贵而诎於人，宁贫贱而轻世肆志焉。'"
- **段落位置**: [11.6]-[11.7]
- **年代推断**: 紧接083-006聊城陷落之后，应与之同期。从'其後二十馀年'推算，约前237年
...
- **原文引用**: "@鲁连@乃为书，约之矢以射城中，遗&燕&将。"
- **段落位置**: [10.1]-[10.6]
- **年代推断**： 第一轮将此从前249年改为前237年（按'二十馀年'字面推算257-20=237），但田单前279年复齐时已为壮年，到前237年约80-90岁以上极可能已故。聊城之事通行系年约在前255—前249年（田单仍活跃于前264年赵国之行）。'二十馀年'为概数，原始标注前249年更合理，应回改

...
你的任务是审查并修正《史记》115_朝鲜列传的事件索引中的年代标注。
...
1. **事件索引**（待审查和修改）：`kg/events/data/115_朝鲜列传_事件索引.md`
...
### 第三步：读取事件索引
完整读取 `kg/events/data/115_朝鲜列传_事件索引.md`，统计事件总数，识别锚点分布（有多少个精确纪年事件、推断纪年事件、无纪年事件）。
...
|--------|---------|---------|------|------|---------|------|
| 115-001 | 卫满亡命立朝鲜 | 继位 | [约公元前195年] | =朝鲜=、=浿水=、=王险= | @满@、@卢绾@ | &汉& |
...
| 115-010 | 左将军围王险城 | 战争 | [约公元前108年] | =王险= | @荀彘@、@杨仆@ | &汉& |
| 115-011 | 两将不和公孙遂执楼船 | 政治活动 | [约公元前108年] | =王险= | @荀彘@、@杨仆@、@公孙遂@ | &汉& |
...
| 事件ID | 事件名称 | 事件类型 | 时间 | 地点 | 主要人物 | 朝代 |
|--------|---------|---------|------|------|---------|------|
| 115-001 | 卫满亡命立朝鲜 | 继位 | [公元前195年] | =朝鲜=、=浿水=、=王险= | @满@、@卢绾@ | &汉& |
| 115-002 | 卫满约为外臣 | 政治活动 | %孝惠%、%高后%时 [约公元前192年] | =辽东= | @满@ | &汉& |
| 115-003 | 卫满侵降旁小邑 | 政治活动 | [约公元前190年] | =真番=、=临屯= | @满@ | &汉& |
| 115-004 | 右渠拒汉拥阏朝见 | 政治活动 | %元封二年% （公元前109年） | =朝鲜= | @右渠@、@涉何@ | &汉& |
| 115-005 | 涉何刺杀朝鲜裨王 | 政治活动 | %元封二年% （公元前109年） | =浿水= | @涉何@ | &汉& |
...
- **原文引用**: "=朝鲜=王@满@者，故&燕&人也。……@满@亡命，聚党千馀人，魋结~蛮夷~服而东走出塞，渡=浿水=，居&秦&故空地上下鄣……都=王险=。"
- **段落位置**: [0]
- **年代推断**: 年表前195年明确记载'燕王卢绾反，遣樊哙往击。绾败，逃入匈奴'，卫满作为卢绾部下随即亡命朝鲜，时间可从卢绾反年精确推算，应从'约'升级为确定推算
...
- **原文引用**: "@右渠@见使者顿首谢：'原降，恐两将诈杀臣；今见信节，请服降。'遣太子入谢……太子亦疑使者$左将军$诈杀之，遂不渡=浿水=，复引归。"
- **段落位置**: [4]
- **年代推断**： 卫山谕降发生在元封二年秋出兵初战失败之后、围城之前，仍属元封二年（前109年）事件序列，可从近似推算升级为确定推算。原文叙事顺序紧接115-007/008之后

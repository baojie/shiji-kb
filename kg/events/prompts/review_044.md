...
你的任务是审查并修正《史记》044_魏世家的事件索引中的年代标注。
...
1. **事件索引**（待审查和修改）：`kg/events/data/044_魏世家_事件索引.md`
...
### 第二步：建立时代框架
本章涉及战国（魏）时期。
参照 `reign_periods.json` 中相关国家（魏）的国君在位年数据。
春秋：前770年-前476年；战国：前475年-前221年。
年表（`中国历史大事年表.md`）可用于交叉验证关键事件。

### 第三步：读取事件索引
完整读取 `kg/events/data/044_魏世家_事件索引.md`，统计事件总数，识别锚点分布（有多少个精确纪年事件、推断纪年事件、无纪年事件）。
...
- **Claude反思修正**：在 001, 003, 004, 005, 010, 009, 008, 002, 013, 015, 014, 012, 011, 026, 017, 023, 024, 025, 019, 037, 027, 028, 029, 041, 042, 043 中出现
...
| 044-003 | 魏绛和戎 | 政治改革 | [约公元前569年] | - | @魏绛@、$晋悼公$ | &晋& |
| 044-004 | 魏献子为国政 | 政治活动 | $顷公$%十二年% | - | @魏献子@、@赵简子@ | &晋& |
| 044-005 | 三家灭知伯 | 战争 | [约公元前453年] | - | @魏桓子@、@韩康子@、@赵襄子@ | &晋& |
| 044-006 | 魏文侯建国 | 继位 | $文侯$%元年% | - | $魏文侯$ | &魏& |
| 044-007 | 三家列为诸侯 | 政治活动 | %二十二年% | - | @魏@、@赵@、@韩@ | &魏& |
...
| 044-014 | 惠王招贤 | 政治活动 | [约公元前340年] | - | $惠王$、@孟轲@、@邹衍@ | &魏& |
...
- **段落位置**: [13]
- **年代推断**: 章节插值：前锚044-013(前340年)，后锚044-016(前322年)，取前锚
...
- **段落位置**: [20]
- **年代推断**: 章节插值：前锚044-016(前322年)，后锚044-020(前257年)，秦昭王在位期间，取中段估值
...
| 044-002 | 魏武子从重耳 | 政治活动 | [约公元前636年] | - | @魏武子@、$重耳$ | &晋& |
| 044-003 | 魏绛和戎 | 政治改革 | [约公元前569年] | - | @魏绛@、$晋悼公$ | &晋& |
| 044-004 | 魏献子为国政 | 政治活动 | $顷公$%十二年% （公元前514年）统一到概览表 | - | @魏献子@、@赵简子@ | &晋& |
| 044-005 | 三家灭知伯 | 战争 | （公元前453年） | - | @魏桓子@、@韩康子@、@赵襄子@ | &晋& |
| 044-006 | 魏文侯建国 | 继位 | $文侯$%元年% （公元前424年）统一到概览表 | - | $魏文侯$ | &魏& |
| 044-007 | 三家列为诸侯 | 政治活动 | %二十二年% （公元前403年）统一到概览表 | - | @魏@、@赵@、@韩@ | &魏& |
| 044-008 | 文侯礼贤 | 文化活动 | [约公元前403年] | - | $文侯$、@子夏@、@段干木@ | &魏& |
| 044-009 | 李克论相 | 政治活动 | [约公元前400年] | - | $魏文侯$、@李克@、$魏成子$、@翟璜@ | &魏& |
| 044-010 | 惠王即位浊泽之危 | 战争 | $惠王$%元年% （公元前369年） | =浊泽= | $惠王$、$韩懿侯$、$赵成侯$ | &魏& |
| 044-011 | 桂陵之战 | 战争 | %十八年% （公元前353年） | =桂陵= | @田忌@、@孙膑@ | &魏&、&齐& |
| 044-012 | 马陵之战 | 战争 | %三十年% （公元前341年） | =马陵= | @庞涓@、$太子申$、@孙子@ | &魏&、&齐& |
...
| 044-015 | 襄王相王 | 政治活动 | $襄王$%元年% （公元前318年） | =徐州= | $襄王$ | &魏& |
| 044-016 | 张仪相魏 | 政治活动 | %十三年% （公元前322年）——注意时序 | - | @张仪@ | &魏&、&秦& |
| 044-017 | 中旗谏秦 | 政治活动 | [约公元前280年] | - | @冯琴@、$秦昭王$ | &魏&、&秦& |
| 044-018 | 唐雎说秦救魏 | 政治活动 | [约公元前276年] | - | @唐雎@、$秦昭王$ | &魏&、&秦& |
| 044-019 | 信陵君谏伐韩 | 政治活动 | [约公元前260年] | - | $无忌$、$魏王$ | &魏& |
| 044-020 | 信陵君救赵 | 战争 | %二十年% （公元前257年） | =邯郸= | $信陵君$、$晋鄙$ | &魏&、&赵& |
...
- **原文引用**: "@魏献子@为国政。"
- **段落位置**: [4]
- **年代推断**: 概览表与详情不一致：概览表缺少公元前514年标注。年表前514年条确认'晋顷公十二年，韩宣子死，魏献子为政'，应统一为精确纪年
...
- **原文引用**: "@桓子@之孙曰$@文侯@都@$。"
- **段落位置**: [4.4]
- **年代推断**: 确定性标注不足（错误模式7）：年表前453年条明确记载'知伯决水灌晋阳。赵臣张孟谈说韩、魏与赵联合...擒杀知伯，三分其地'，应升级为精确纪年

### 044-006 魏文侯建国
- **事件类型**: 继位
- **时间**: $文侯$%元年% （公元前424年）统一到概览表
- **地点**: -
- **主要人物**: $魏文侯$
- **涉及朝代**: &魏&
- **事件描述**: 桓子之孙文侯都即位，与韩武子、赵桓子同时。伐秦筑临晋、元里，伐中山使子击守之。
- **原文引用**: "$@魏文侯@$%元年%，$@秦灵公@$之%元年%也。"
- **段落位置**: [5]
- **年代推断**: 概览表与详情不一致。年表前424年条确认'秦灵公元年。韩武子元年。赵桓子元年'，与原文'文侯元年，秦灵公之元年也'吻合。注：年表另有前445年'魏文侯新元年'条，为学术界另一纪年系统，此处从《史记》

### 044-007 三家列为诸侯
- **事件类型**: 政治活动
- **时间**: %二十二年% （公元前403年）统一到概览表
- **地点**: -
- **主要人物**: @魏@、@赵@、@韩@
- **涉及朝代**: &魏&
- **事件描述**: 魏、赵、韩列为诸侯，正式从晋卿升为独立诸侯国。
- **原文引用**: "%二十二年%，@魏@、@赵@、@韩@列为诸侯。"
- **段落位置**: [5.4]
- **年代推断**: 概览表与详情不一致。年表前403年条明确记载'周命魏斯、赵籍、韩虔为诸侯'，应统一标注
...
- **原文引用**: "$@文侯@$受@子夏@经艺，客@段干木@，过其闾，未尝不轼也。"
- **段落位置**: [6]
- **年代推断**: 年表前403年条明确记载'文侯师事卜子夏、田子方、段干木；用西门豹治邺'，与本事件描述完全吻合。原标注前420年偏早，年表将此事系于三家列为诸侯同年。但因文侯礼贤为持续行为非单一事件，用推断标注更合适
...
- **原文引用**: "@孟轲@曰：'君不可以言利若是。……为人君，仁义而已矣，何以利为！'"
- **段落位置**: [13]
- **年代推断**： 年表前320年条记载'孟轲约于本年或公元前322年至魏见惠王'，前319年条记载'惠王死，子襄王嗣立。孟轲约于襄王即位后赴齐'。孟轲至梁在惠王晚年（前322-前320年），非前340年。原标注偏早约20年
...
- **原文引用**: "%十三年%，@张仪@相@魏@。"
- **段落位置**: [14.4]
- **年代推断**: 年表前322年条确认'魏惠王后元十三年...用张仪为相'，年份正确。但此事件（前322年）早于044-015襄王相王（前318年），概览表中044-016排在044-015之后，时间顺序倒置。这是因为原文叙事先述襄王事再追叙惠王末年事
...
- **自然灾害**: 0
- **经济活动**: 0
- **年代推断**: 年表前225年条明确记载'秦王贲攻魏，决水灌大梁，三月后城坏。魏王假降，在位三年。魏亡'。年份正确。但详情部分缺少年代推断行，应补充
...
| 044-002 | 魏武子从重耳 | 政治活动 | [约公元前636年] | - | @魏武子@、$重耳$ | &晋& |
| 044-003 | 魏绛和戎 | 政治改革 | [约公元前569年] | - | @魏绛@、$晋悼公$ | &晋& |
| 044-004 | 魏献子为国政 | 政治活动 | $顷公$%十二年% 统一到概览表 统一到概览表 （公元前514年）统一到概览表 | - | @魏献子@、@赵简子@ | &晋& |
| 044-005 | 三家灭知伯 | 战争 | （公元前453年） | - | @魏桓子@、@韩康子@、@赵襄子@ | &晋& |
| 044-006 | 魏文侯建国 | 继位 | $文侯$%元年% 统一到概览表 统一到概览表 （公元前424年）统一到概览表 | - | $魏文侯$ | &魏& |
| 044-007 | 三家列为诸侯 | 政治活动 | %二十二年% 统一到概览表 统一到概览表 （公元前403年）统一到概览表 | - | @魏@、@赵@、@韩@ | &魏& |
| 044-008 | 文侯礼贤 | 文化活动 | [约公元前403年] | - | $文侯$、@子夏@、@段干木@ | &魏& |
| 044-009 | 李克论相 | 政治活动 | [约公元前400年] | - | $魏文侯$、@李克@、$魏成子$、@翟璜@ | &魏& |
| 044-010 | 惠王即位浊泽之危 | 战争 | $惠王$%元年% （公元前369年） | =浊泽= | $惠王$、$韩懿侯$、$赵成侯$ | &魏& |
| 044-011 | 桂陵之战 | 战争 | %十八年% （公元前353年） | =桂陵= | @田忌@、@孙膑@ | &魏&、&齐& |
...
| 044-014 | 惠王招贤 | 政治活动 | [约公元前320年] | - | $惠王$、@孟轲@、@邹衍@ | &魏& |
| 044-015 | 襄王相王 | 政治活动 | $襄王$%元年% （公元前318年） | =徐州= | $襄王$ | &魏& |
| 044-016 | 张仪相魏 | 政治活动 | %十三年% ——注意时序 ——注意时序 （公元前322年）——注意时序 | - | @张仪@ | &魏&、&秦& |
| 044-017 | 中旗谏秦 | 政治活动 | [约公元前280年] | - | @冯琴@、$秦昭王$ | &魏&、&秦& |
| 044-018 | 唐雎说秦救魏 | 政治活动 | [约公元前276年] | - | @唐雎@、$秦昭王$ | &魏&、&秦& |
| 044-019 | 信陵君谏伐韩 | 政治活动 | [约公元前260年] | - | $无忌$、$魏王$ | &魏& |
| 044-020 | 信陵君救赵 | 战争 | %二十年% （公元前257年） | =邯郸= | $信陵君$、$晋鄙$ | &魏&、&赵& |
...
### 044-004 魏献子为国政
- **事件类型**: 政治活动
- **时间**: $顷公$%十二年% 统一到概览表 统一到概览表 （公元前514年）统一到概览表
- **地点**: -
- **主要人物**: @魏献子@、@赵简子@
- **涉及朝代**: &晋&
- **事件描述**: 韩宣子老，魏献子为国政。六卿诛祁氏、羊舌氏，取其邑为十县。献子与赵简子等并为晋卿。
...
### 044-006 魏文侯建国
- **事件类型**: 继位
- **时间**: $文侯$%元年% 统一到概览表 统一到概览表 （公元前424年）统一到概览表
- **地点**: -
- **主要人物**: $魏文侯$
- **涉及朝代**: &魏&
- **事件描述**: 桓子之孙文侯都即位，与韩武子、赵桓子同时。伐秦筑临晋、元里，伐中山使子击守之。
...
### 044-007 三家列为诸侯
- **事件类型**: 政治活动
- **时间**: %二十二年% 统一到概览表 统一到概览表 （公元前403年）统一到概览表
- **地点**: -
- **主要人物**: @魏@、@赵@、@韩@
- **涉及朝代**: &魏&
- **事件描述**: 魏、赵、韩列为诸侯，正式从晋卿升为独立诸侯国。

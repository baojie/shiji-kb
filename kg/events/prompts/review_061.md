...
你的任务是审查并修正《史记》061_伯夷列传的事件索引中的年代标注。
...
1. **事件索引**（待审查和修改）：`kg/events/data/061_伯夷列传_事件索引.md`
...
### 第三步：读取事件索引
完整读取 `kg/events/data/061_伯夷列传_事件索引.md`，统计事件总数，识别锚点分布（有多少个精确纪年事件、推断纪年事件、无纪年事件）。
...
- **Claude反思修正**：在 001, 003, 007, 004, 005, 010, 009, 002, 008, 014, 013, 011, 019, 016, 015, 025, 012, 023, 030, 024, 026, 029, 034, 035, 032, 036, 028, 033, 037, 038, 039, 040, 041, 042, 043, 044, 045, 046, 047, 048, 049, 050, 052, 056, 057, 058, 059, 060 中出现
...
| 061-007 | 颜渊穷困早夭 | 家族事件 | [约公元前481年] | - | @颜渊@ | - |
...
- **段落位置**: [2]
- **年代推断**: 颜回(前521-前481)，卒于鲁哀公十四年(前481年)
...
- **原文引用**: "@伯夷@、@叔齐@叩*马*而谏曰：'父死不葬，爰及干戈，可谓孝乎？以臣弑君，可谓仁乎？'左右欲兵之。太公曰：'此义人也。'扶而去之。"
- **段落位置**: [1]
- **年代推断**: 年表前1046年明确记载武王伐纣牧野之战，应使用精确纪年格式（圆括号）而非无标记格式。当前标注缺少圆括号，不符合标记规范。
...
- **原文引用**: "且七十子之徒，仲尼独荐@颜渊@为好学。然回也屡空，糟糠不厌，而卒蚤夭。"
- **段落位置**: [2]
- **年代推断**: 年表前481年条明确记载'孔丘弟子颜回（渊）死'，属确定性标注不足（错误模式7），应从近似推算[约]升级为精确纪年（）。

...
你的任务是审查并修正《史记》055_留侯世家的事件索引中的年代标注。
...
1. **事件索引**（待审查和修改）：`kg/events/data/055_留侯世家_事件索引.md`
...
### 第三步：读取事件索引
完整读取 `kg/events/data/055_留侯世家_事件索引.md`，统计事件总数，识别锚点分布（有多少个精确纪年事件、推断纪年事件、无纪年事件）。
...
| 055-007 | 劝沛公还军霸上 | 政治活动 | （公元前207年） | =咸阳= | @张良@、@樊哙@ | &秦& |
...
| 055-022 | 张良卒谥文成侯 | 家族事件 | （公元前186年） | - | @张良@ | &汉& |
...
- **段落位置**: [8]
- **年代推断**: 《年表》前206年十月（秦历，实为前207年底）：刘邦听张良言还军霸上
...
- **段落位置**: [27]
- **年代推断**: 《年表》前185年(高后三年)记张良死；"后八年"从惠帝即位(前194年)算约为前186年
...
- **原文引用**: "後%八年%卒，谥为文成$侯$。子不疑=代=侯。"
- **段落位置**: [27]
- **年代推断**: 年表前185年（高后三年）明确记载'留侯张良死'。原标注前186年系从'後八年卒'推算，但起算基准有误。应以年表记载为准。

...
你的任务是审查并修正《史记》126_滑稽列传的事件索引中的年代标注。
...
1. **事件索引**（待审查和修改）：`kg/events/data/126_滑稽列传_事件索引.md`
...
### 第二步：建立时代框架
本章为通论性质（滑稽列传），时间跨度可能从远古到汉武帝，横跨多个时代。
**重点检查**：
...
### 第三步：读取事件索引
完整读取 `kg/events/data/126_滑稽列传_事件索引.md`，统计事件总数，识别锚点分布（有多少个精确纪年事件、推断纪年事件、无纪年事件）。
...
| 126-005 | 优孟为孙叔敖子请封 | 政治活动 | [约公元前595年] | =寝丘= | @优孟@、@楚庄王@、@孙叔敖@ | &楚& |
...
| 126-013 | 西门豹破河伯娶妇 | 政治改革 | [约公元前400年] | =鄴= | @西门豹@ | &魏& |
| 126-014 | 西门豹凿十二渠 | 建设 | [约公元前400年] | =鄴= | @西门豹@ | &魏& |
...
- **段落位置**: [6]
- **年代推断**: 孙叔敖约卒于前597年前后，"数年后"其子往见优孟，约前595年；庄王在位前613年-前591年（年表）
...
- **段落位置**: [22]
- **年代推断**: 原标注前332年为单锚点塌缩错误；年表载前403年魏文侯"用西门豹治邺"，治邺在文侯时期（前445年-前396年），取约前400年
...
- **段落位置**: [23]
- **年代推断**: 原标注前332年为单锚点塌缩错误；与126-013同期，西门豹治邺在魏文侯时（年表前403年），取约前400年
...
| 126-003 | 淳于髡论饮酒讽长夜 | 政治活动 | [约公元前349年] | - | @淳于髡@、@齐威王@ | &齐& |
| 126-004 | 优孟谏楚庄王葬马 | 政治活动 | [约公元前600年] | - | @优孟@、@楚庄王@ | &楚& |
| 126-005 | 优孟为孙叔敖子请封 | 政治活动 | [约公元前590年] | =寝丘= | @优孟@、@楚庄王@、@孙叔敖@ | &楚& |
| 126-006 | 优旃谏秦始皇苑囿 | 政治活动 | [约公元前220年] | - | @优旃@、@始皇@ | &秦& |
| 126-007 | 优旃谏二世漆城 | 政治活动 | [约公元前209年] | - | @优旃@、@二世@ | &秦& |
| 126-008 | 郭舍人救武帝乳母 | 政治活动 | [约公元前120年] | - | @郭舍人@、@武帝@ | &汉& |
| 126-009 | 东方朔上书三千牍 | 政治活动 | （公元前140年） | =长安= | @东方朔@、@武帝@ | &汉& |
...
- **原文引用**: "於是@庄王@谢@优孟@，乃召@孙叔敖@子，封之=寝丘=%四百户%，以奉其祀。後%十世%不绝。"
- **段落位置**: [6]
- **年代推断**: 年表前591年条记载楚庄王死，并提及'庄王时有优孟，传曾扮作放令尹孙叔敖'。孙叔敖约卒于前597年（邲之战前后为令尹），其子'负薪'来见优孟时已过'数年'，优孟装扮孙叔敖并面见庄王请封之事当在庄王晚年，约前591年前后。前595年偏早，庄王在前591年即去世，此事更可能在前593-前591年间

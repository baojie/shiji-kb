...
你的任务是审查并修正《史记》094_田儋列传的事件索引中的年代标注。
...
1. **事件索引**（待审查和修改）：`kg/events/data/094_田儋列传_事件索引.md`
...
### 第三步：读取事件索引
完整读取 `kg/events/data/094_田儋列传_事件索引.md`，统计事件总数，识别锚点分布（有多少个精确纪年事件、推断纪年事件、无纪年事件）。
...
- **Claude反思修正**：在 001, 003, 007, 004, 005, 010, 009, 002, 008, 014, 013, 011, 019, 016, 015, 025, 012, 023, 030, 024, 026, 029, 034, 035, 032, 036, 028, 033, 037, 038, 039, 040, 041, 042, 043, 044, 045, 046, 047, 048, 049, 050, 052, 056, 057, 058, 059, 060, 061, 062, 063, 064, 065, 066, 067, 068, 069, 070, 071, 073, 075, 076, 078, 079, 083, 086, 087, 089, 090, 093 中出现
...
| 094-010 | 郦生说齐罢兵 | 政治活动 | （公元前204年） | =历下= | @郦生@、@田广@、@田横@ | &汉& |
...
- **段落位置**: [10]
- **年代推断**: 据《中国历史大事年表》前204年：郦食其说齐王田广；原文"横定齐三年"亦合（前205年至前204年约三年）

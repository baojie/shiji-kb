...
你的任务是审查并修正《史记》128_龟策列传的事件索引中的年代标注。
...
1. **事件索引**（待审查和修改）：`kg/events/data/128_龟策列传_事件索引.md`
...
### 第二步：建立时代框架
本章为通论性质（龟策列传），时间跨度可能从远古到汉武帝，横跨多个时代。
**重点检查**：
...
### 第三步：读取事件索引
完整读取 `kg/events/data/128_龟策列传_事件索引.md`，统计事件总数，识别锚点分布（有多少个精确纪年事件、推断纪年事件、无纪年事件）。
...
| 128-004 | 献公贪骊姬祸流五世 | 家族事件 | [约公元前656年] | - | @献公@、@骊姬@ | &晋& |
| 128-005 | 武帝博开卜筮之路 | 文化活动 | [约公元前130年] | - | @丘子明@ | &汉& |
| 128-006 | 巫蛊之祸诛灭三族 | 政治整顿 | [约公元前91年] | - | - | &汉& |
| 128-007 | 宋元王梦得神龟 | 文化活动 | %宋元王二年% [约公元前530年] | =泉阳= | @宋元王@、@豫且@、@卫平@ | &宋& |
| 128-008 | 卫平谏留神龟 | 政治活动 | [约公元前530年] | - | @卫平@、@宋元王@ | &宋& |
...
- **段落位置**: [3]
- **年代推断**: 据《中国历史大事年表》前635年条：晋文公送周襄王还王城，杀太叔带，定襄王之位，周赐晋阳樊等地。此即"定襄王之位"事
...
- **段落位置**: [3]
- **年代推断**: 晋献公五年（前672年）攻骊戎得骊姬，骊姬逼太子申生自杀在前656年。此事以骊姬之祸的高潮为标志时间点
...
- **段落位置**: [2]
- **年代推断**: 据《中国历史大事年表》，巫蛊案始于征和元年（前92年），高潮在征和二年（前91年），江充治巫蛊狱，连坐被杀者数万人，后事觉奸穷亦诛三族
...
- **段落位置**: [10]
- **年代推断**: 据《中国历史大事年表》前531年条，宋元公元年；则宋元王二年为前530年
...
- **段落位置**: [12]-[17]
- **年代推断**: 紧接128-007宋元王得龟事件之后，同在宋元公二年（前530年）
...
- **原文引用**: "&宋元王&%二年%，=江=使神^龟^使於=河=，至於=泉阳=，渔者@豫且@举网得而囚之……^龟^来见梦於&宋元王&。"
- **段落位置**: [10]
- **年代推断**: 年表前531年明确记载'宋元公元年'，宋元公二年=531-(2-1)=前530年，为reign-year精确换算，应去掉'约'字
...
- **原文引用**: "@元王@大悦而喜。於是@元王@向!日!而谢，再拜而受。择日斋戒，甲乙最良。乃刑*白雉*，及与*骊羊*；以*血*灌^龟^，於坛中央。"
- **段落位置**: [12]-[17]
- **年代推断**: 紧接128-007宋元公二年得龟事件之后，同在前530年，为确定推算而非近似推算，应去掉'约'字

...
你的任务是审查并修正《史记》038_宋微子世家的事件索引中的年代标注。
...
1. **事件索引**（待审查和修改）：`kg/events/data/038_宋微子世家_事件索引.md`
...
### 第二步：建立时代框架
本章涉及春秋（宋）时期。
参照 `reign_periods.json` 中相关国家（宋）的国君在位年数据。
春秋：前770年-前476年；战国：前475年-前221年。
年表（`中国历史大事年表.md`）可用于交叉验证关键事件。

### 第三步：读取事件索引
完整读取 `kg/events/data/038_宋微子世家_事件索引.md`，统计事件总数，识别锚点分布（有多少个精确纪年事件、推断纪年事件、无纪年事件）。
...
- **Claude反思修正**：在 001, 003, 007, 004, 005, 010, 009, 002, 008, 014, 013, 011, 019, 016, 015, 025, 012, 023, 030, 024, 026, 029, 034, 035, 032, 036, 028, 033, 037 中出现
...
|--------|---------|---------|------|------|---------|------|
| 038-001 | 微子箕子谏纣 | 政治活动 | [约公元前1076年] | - | @微子开@、@箕子@、@纣@ | &殷& |
| 038-002 | 比干死谏微子去殷 | 政治活动 | [约公元前1076年] | - | @比干@、@微子@、@纣@ | &殷& |
| 038-003 | 微子肉袒降周 | 政治活动 | [约公元前1046年] | - | @微子@、@武王@ | &殷&、&周& |
| 038-004 | 箕子陈洪范九畴 | 文化活动 | [约公元前1046年] | - | @箕子@、@武王@ | &周& |
| 038-005 | 封箕子于朝鲜 | 政治活动 | [约公元前1046年] | =朝鲜= | @箕子@、@武王@ | &周& |
...
| 038-016 | 荧惑守心景公三善 | 自然灾害 | [约公元前480年] | &宋& | @景公@、@子韦@ | &宋& |
| 038-017 | 昭公篡杀太子自立 | 继位 | （公元前469年） | &宋& | @昭公@、@景公@ | &宋& |
| 038-018 | 宋王偃暴虐 | 政治活动 | [约公元前318年] | &宋& | @王偃@ | &宋& |
...
- **段落位置**: [1.1-1.2]
- **年代推断**: 纣在位期间(前1075年~前1046年)，取中点前1076年（约数）
...
- **段落位置**: [3.5]
- **年代推断**: 武王克殷之年，据《中国历史大事年表》为前1046年
...
- **段落位置**: [43.55]
- **年代推断**: 据年表，偃在位四十三年亡于前286年，偃元年约前328年，十一年称王约前318年

...
你的任务是审查并修正《史记》062_管晏列传的事件索引中的年代标注。
...
1. **事件索引**（待审查和修改）：`kg/events/data/062_管晏列传_事件索引.md`
...
### 第三步：读取事件索引
完整读取 `kg/events/data/062_管晏列传_事件索引.md`，统计事件总数，识别锚点分布（有多少个精确纪年事件、推断纪年事件、无纪年事件）。
...
- **Claude反思修正**：在 001, 003, 004, 005, 010, 009, 008, 002, 013, 015, 014, 012, 011, 026, 017, 023, 024, 025, 019, 037, 027, 028, 029, 041, 042, 043, 044, 045, 046, 047, 049, 050, 052, 053, 055, 056, 057, 058, 059, 060, 061 中出现
...
|--------|---------|---------|------|------|---------|------|
| 062-001 | 管仲鲍叔早年交游 | 文化活动 | [约公元前710年] | =颍上= | @管仲@、@鲍叔牙@ | - |
...
| 062-005 | 管仲相齐称霸 | 政治改革 | 公元前685年 | =齐= | @管仲@、@齐桓公@ | &齐& |
...
| 062-010 | 晏子事三君显名 | 政治活动 | [约公元前556年] | =齐= | @晏子@、@齐灵公@ | &齐& |
...
- **段落位置**: [1]
- **年代推断**: 据《年表》前686年，齐襄公被杀，管仲奉公子纠奔鲁，鲍叔牙先已奉公子小白奔莒
...
- **段落位置**: [1]
- **年代推断**: 据《年表》前685年，齐桓公元年，小白先入即位，齐迫鲁杀公子纠、交出管仲
...
- **段落位置**: [1]、[3]
- **年代推断**: 据《年表》前685年，鲍叔牙向桓公推荐管仲，公任管仲为卿
...
- **段落位置**: [4]
- **年代推断**: 据《年表》前685年，管仲任政于齐，分国为士乡与工商乡，兴鱼盐之利，齐国渐强；前679年齐始霸
...
- **段落位置**: [5]
- **年代推断**: 据《年表》前656年，齐桓公会诸侯攻蔡、伐楚，与楚屈完盟于召陵
...
- **段落位置**: [5]
- **年代推断**: 据《年表》前663年，齐桓公攻山戎以救燕，至孤竹而还
...
- **段落位置**: [7]
- **年代推断**: 晏婴(前578-前500)约前556年为齐卿，始事齐灵公
...
- **段落位置**: [11]
- **年代推断**: 据《年表》前548年，崔杼杀齐庄公，晏婴哭庄公，崔杼以晏素得民心不问
...
- **原文引用**: "已而@鲍叔@事齐@公子小白@，@管仲@事@公子纠@。"
- **段落位置**: [1]
- **年代推断**: 年表前686年明确记载'管仲奉公子纠奔鲁'，应使用圆括号精确纪年格式（公元前686年），当前缺少格式标记
...
- **原文引用**: "及小白立为@桓公@，@公子纠@死，@管仲@囚焉。"
- **段落位置**: [1]
- **年代推断**: 年表前685年明确记载'小白先入即位，齐迫鲁杀公子纠、交出管仲'，应使用圆括号精确纪年格式
...
- **原文引用**: "@鲍叔@遂进@管仲@。""@鲍叔@既进@管仲@，以身下之。子孙世禄於=齐=，有封邑者十馀世，常为名$大夫$。"
- **段落位置**: [1]、[3]
- **年代推断**: 年表前685年明确记载'鲍叔牙向桓公推荐管仲，公任管仲为卿'，应使用圆括号精确纪年格式
...
- **原文引用**: "@管仲@既任^政^相=齐=，以区区之=齐=在海滨，通货积财，富国彊兵，与俗同好恶。"
- **段落位置**: [4]
- **年代推断**: 管仲任政始于前685年（年表确认），但齐始霸于前679年（年表'齐始霸'），事件描述涵盖管仲任政到称霸全过程，应标注为时间区间。年代推断中已提到前679年齐始霸，但时间字段未体现
...
- **原文引用**: "@桓公@实怒少姬，南袭=蔡=，@管仲@因而伐=楚=，责包茅不入贡於=周=室。"
- **段落位置**: [5]
- **年代推断**: 年表前656年明确记载'齐桓公会诸侯攻蔡、伐楚，与楚屈完盟于召陵'，应使用圆括号精确纪年格式
...
- **原文引用**: "@桓公@实北征山~戎~，而@管仲@因而令=燕=修召公之^政^。"
- **段落位置**: [5]
- **年代推断**: 年表前663年明确记载'齐桓公攻山戎以救燕，至孤竹而还'，应使用圆括号精确纪年格式
...
- **原文引用**: "於柯之会，@桓公@欲背=曹=沫之约，@管仲@因而信之，诸侯由是归=齐=。"
- **段落位置**: [5]
- **年代推断**: 年表前681年明确记载'齐、鲁和好，盟于柯'，应使用圆括号精确纪年格式
...
- **原文引用**: "@管仲@卒，=齐国=遵其^政^，常彊於诸侯。後百馀年而有@晏子@焉。"
- **段落位置**: [6]
- **年代推断**: 年表前645年明确记载'管仲死'，应使用圆括号精确纪年格式
...
- **原文引用**: "方@晏子@伏庄公尸哭之，成^礼^然後去，岂所谓'见义不为无勇'者邪？"
- **段落位置**: [11]
- **年代推断**: 年表前548年明确记载'崔杼杀庄公'及'晏婴哭庄公，崔杼以晏素得民心，不问'，应使用圆括号精确纪年格式
...
| 062-002 | 管仲事公子纠 | 政治活动 | [约公元前694年] | =齐= | @管仲@、@公子纠@、@公子小白@ | &齐& |
| 062-003 | 桓公即位管仲被囚 | 政治活动 | （公元前685年） | =齐= | @桓公@、@管仲@、@公子纠@ | &齐& |
| 062-004 | 鲍叔荐管仲 | 政治活动 | （公元前685年） | =齐= | @鲍叔@、@管仲@、@齐桓公@ | &齐& |
| 062-005 | 管仲相齐称霸 | 政治改革 | （公元前685年—前679年） | =齐= | @管仲@、@齐桓公@ | &齐& |
| 062-006 | 桓公伐楚责贡 | 战争 | （公元前656年） | =楚= | @桓公@、@管仲@ | &齐&、&周& |
...
- **原文引用**: "已而@鲍叔@事齐@公子小白@，@管仲@事@公子纠@。"
- **段落位置**: [1]
- **年代推断**: 管仲事公子纠应在齐襄公在位期间（前697-前686年），公子纠奔鲁避祸约在前694年左右，非前686年（前686年是齐襄公被弑、诸公子争位之年）。管仲开始辅佐公子纠应更早

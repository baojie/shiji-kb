...
你的任务是审查并修正《史记》020_建元以来侯者年表的事件索引中的年代标注。
...
1. **事件索引**（待审查和修改）：`kg/events/data/020_建元以来侯者年表_事件索引.md`
...
### 第三步：读取事件索引
完整读取 `kg/events/data/020_建元以来侯者年表_事件索引.md`，统计事件总数，识别锚点分布（有多少个精确纪年事件、推断纪年事件、无纪年事件）。
...
- [warning] 020-010: 时间字段含原文纪年但无公元年转换: %元狩二年至四年% （公元前121年-前119年）
...
|--------|---------|---------|------|------|---------|------|
| 020-001 | 匈奴绝和亲攻当路塞 | 战争 | [约公元前133年] | - | - | &汉& |
...
- **原文引用**: "~匈奴~绝和亲，攻当路塞"
- **段落位置**: [1.1]
- **年代推断**: 据《中国历史大事年表》，元光二年（前133年）马邑之谋后匈奴绝和亲，攻扰更甚。原标注[约前127年]系单锚点塌缩至020-003，已修正

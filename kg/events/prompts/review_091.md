...
你的任务是审查并修正《史记》091_黥布列传的事件索引中的年代标注。
...
1. **事件索引**（待审查和修改）：`kg/events/data/091_黥布列传_事件索引.md`
...
### 第二步：建立时代框架
本章涉及秦末楚汉（黥布）时期。参照 `reign_periods.json` 和 `中国历史大事年表.md` 中的相关数据。

### 第三步：读取事件索引
完整读取 `kg/events/data/091_黥布列传_事件索引.md`，统计事件总数，识别锚点分布（有多少个精确纪年事件、推断纪年事件、无纪年事件）。
...
- [warning] 091-017: 时间字段含原文纪年但无公元年转换: %七年%至%九年% （公元前200年—前198年）
...
|--------|---------|---------|------|------|---------|------|
| 091-001 | 黥布少年相面 | 家族事件 | [约公元前209年] | =六= | @黥布@、@英@ | &秦& |
| 091-002 | 黥布论输丽山 | 政治整顿 | [约公元前209年] | =丽山= | @黥布@ | &秦& |
| 091-003 | 黥布起兵反秦 | 战争 | （公元前209年） | =清波= | @黥布@、@番君@、@陈胜@、@章邯@ | &秦& |
| 091-004 | 英布归属项梁 | 战争 | （公元前208年） | =江东=、=会稽= | @英布@、@项梁@、@陈婴@、@蒲将军@ | &楚& |
| 091-005 | 英布常冠军随项梁 | 战争 | [约公元前208年] | =薛=、=定陶= | @英布@、@项梁@ | &楚& |
| 091-006 | 英布先渡河破秦 | 战争 | [约公元前207年] | - | @英布@、@项籍@、@章邯@ | &楚& |
| 091-007 | 坑杀秦卒入咸阳 | 战争 | [约公元前206年] | =新安=、=咸阳= | @英布@、@项籍@、@章邯@ | &楚& |
...
| 091-012 | 英布叛楚归汉 | 战争 | [约公元前204年] | =淮南=、=下邑= | @英布@、@随何@、@项声@、@龙且@ | &汉& |
| 091-013 | 英布入见汉王 | 政治活动 | [约公元前204年] | - | @英布@、&汉&王 | &汉& |
...
- **段落位置**: [3]
- **年代推断**: 章节插值：前锚091-004(前208年)，后锚091-009(前206年)，取前锚
...
- **段落位置**: [8]
- **年代推断**: 章节插值：前锚091-011(前204年)，后锚091-015(前202年)，取前锚

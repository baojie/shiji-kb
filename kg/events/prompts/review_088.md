...
你的任务是审查并修正《史记》088_蒙恬列传的事件索引中的年代标注。
...
1. **事件索引**（待审查和修改）：`kg/events/data/088_蒙恬列传_事件索引.md`
...
### 第二步：建立时代框架
本章涉及秦（蒙恬）时期。参照 `reign_periods.json` 和 `中国历史大事年表.md` 中的相关数据。

### 第三步：读取事件索引
完整读取 `kg/events/data/088_蒙恬列传_事件索引.md`，统计事件总数，识别锚点分布（有多少个精确纪年事件、推断纪年事件、无纪年事件）。
...
|--------|---------|---------|------|------|---------|------|
| 088-001 | 蒙骜伐韩魏立功 | 战争 | $@秦庄襄王@$$元年$ （公元前249年） | =成皋=、=荥阳= | @蒙骜@ | &秦& |
| 088-002 | 蒙武攻楚杀项燕 | 战争 | $@始皇@$%二十三年% （公元前224年） | - | @蒙武@、@王翦@、@项燕@ | &秦&、&楚& |
| 088-003 | 蒙恬攻齐并天下 | 战争 | $@始皇@$%二十六年% （公元前221年） | - | @蒙恬@ | &秦&、&齐& |
| 088-004 | 蒙恬北逐匈奴筑长城 | 建设 | $@始皇@$%三十二年% （公元前215年） | =临洮=、=辽东=、=阳山= | @蒙恬@ | &秦& |
...
| 088-008 | 扶苏蒙恬受诏 | 政治活动 | [约公元前210年] | - | $@扶苏@$、@蒙恬@ | &秦& |
| 088-009 | 赵高谮蒙毅 | 政治活动 | [约公元前210年] | =代= | @赵高@、@蒙毅@、$@胡亥@$ | &秦& |
| 088-010 | 子婴谏勿杀蒙氏 | 政治活动 | [约公元前210年] | - | $@子婴@$、$@胡亥@$ | &秦& |
...
- **段落位置**: [2.1]
- **年代推断**: 据《中国历史大事年表》前215年"命蒙恬发兵三十万攻匈奴"，前214年筑长城

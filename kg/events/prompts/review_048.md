...
你的任务是审查并修正《史记》048_陈涉世家的事件索引中的年代标注。
...
1. **事件索引**（待审查和修改）：`kg/events/data/048_陈涉世家_事件索引.md`
...
### 第二步：建立时代框架
本章涉及秦末（陈涉）时期。参照 `reign_periods.json` 和 `中国历史大事年表.md` 中的相关数据。

### 第三步：读取事件索引
完整读取 `kg/events/data/048_陈涉世家_事件索引.md`，统计事件总数，识别锚点分布（有多少个精确纪年事件、推断纪年事件、无纪年事件）。
...
- **Claude反思修正**：在 001, 003, 007, 004, 005, 010, 009, 002, 008, 014, 013, 011, 019, 016, 015, 025, 012, 023, 030, 024, 026, 029, 034, 035, 032, 036, 028, 033, 037, 038, 039, 040, 041, 042, 043, 044, 045, 046, 047 中出现
...
- [warning] ALL: 5/13个事件指向前209年，疑似被单一锚点拉偏。涉及: 048-003, 048-004, 048-006, 048-007, 048-008...
...
| 048-003 | 陈涉称王 | 继位 | [约公元前209年] | &陈& | @陈涉@ | &张楚& |
| 048-004 | 各地响应 | 战争 | [约公元前209年] | - | @武臣@、@张耳@、@陈馀@、@邓宗@ | &张楚& |
| 048-005 | 周文伐秦 | 战争 | [约公元前209年—前208年] | =戏=、=曹阳=、=渑池= | @周文@、@章邯@ | &张楚&、&秦& |
| 048-006 | 武臣立为赵王 | 继位 | [约公元前209年] | =邯郸= | @武臣@、@张耳@、@陈馀@ | &赵& |
| 048-007 | 韩广立为燕王 | 继位 | [约公元前209年] | - | @韩广@ | &燕& |
| 048-008 | 魏咎立为魏王 | 继位 | [约公元前209年] | - | @周市@、@魏咎@ | &魏& |
| 048-009 | 田臧杀吴叔 | 战争 | [约公元前208年] | =荥阳=、=敖仓= | @田臧@、$吴叔$、@章邯@ | &张楚&、&秦& |
| 048-010 | 秦嘉叛陈 | 政治活动 | [约公元前209年—前208年] | =郯= | @秦嘉@、$武平君畔$ | &张楚& |
| 048-011 | 陈胜之死 | 战争 | %腊月% （公元前208年） | =下城父= | @陈胜@、$御庄贾$、@章邯@ | &张楚&、&秦& |
| 048-012 | 吕臣复陈 | 战争 | [约公元前208年] | &陈& | @吕臣@ | &楚& |
...
- **原文引用**: "@周文@自刭，军遂不战。"
- **段落位置**: [4]
- **年代推断**: 进军至戏在前209年，败退至渑池自杀在前208年（据《中国历史大事年表》）
...
- **原文引用**: "与战，@田臧@死，军破。"
- **段落位置**: [8]
- **年代推断**: 周文兵败（前208年）后发生，据《中国历史大事年表》吴广被田臧所害在前208年
...
- **原文引用**: "因矫以王命杀$@武平君@畔@$。"
- **段落位置**: [9]
- **年代推断**: 秦嘉起兵或在前209年，立景驹为楚王在前208年（据《中国历史大事年表》）
...
- **段落位置**: [11]
- **年代推断**: 陈胜被杀（前208年腊月）后发生，据《中国历史大事年表》吕臣夺回陈县在前208年

...
你的任务是审查并修正《史记》046_田敬仲完世家的事件索引中的年代标注。
...
1. **事件索引**（待审查和修改）：`kg/events/data/046_田敬仲完世家_事件索引.md`
...
### 第二步：建立时代框架
本章涉及战国（田齐）时期。
参照 `reign_periods.json` 中相关国家（齐、田齐）的国君在位年数据。
春秋：前770年-前476年；战国：前475年-前221年。
年表（`中国历史大事年表.md`）可用于交叉验证关键事件。

### 第三步：读取事件索引
完整读取 `kg/events/data/046_田敬仲完世家_事件索引.md`，统计事件总数，识别锚点分布（有多少个精确纪年事件、推断纪年事件、无纪年事件）。
...
- **Claude反思修正**：在 001, 003, 007, 004, 005, 010, 009, 002, 008, 014, 013, 011, 019, 016, 015, 025, 012, 023, 030, 024, 026, 029, 034, 035, 032, 036, 028, 033, 037, 038, 039, 040, 041, 042, 043, 044, 045 中出现
...
| 046-019 | 襄王复国 | 继位 | [约公元前283年] | &莒& | @法章@、$君王后$ | &齐& |
...
- **段落位置**: [5]
- **年代推断**: 齐景公在位前547-前490年，晏子约卒于前500年；年表前539年载晏婴与叔向论田氏"以家量贷，以公量收"，行阴德当在此前后
...
- **段落位置**: [8]
- **年代推断**: 年表载齐平公五年（约前476年）田常割安平至琅邪为封邑，"封邑大于平公之所食"
...
- **段落位置**: [14-15]
- **年代推断**: 章节插值：前锚046-010(前370年)，后锚046-012(前355年)，取前锚
...
- **段落位置**: [19]
- **年代推断**: 章节插值：前锚046-014(前341年)，后锚046-016(前288年)，取前锚
...
- **段落位置**: [25]
- **年代推断**: 五国伐齐在前284年，湣王被杀后法章即位于莒，约在前283年
...
| 046-002 | 陈厉公之乱 | 政治活动 | （公元前707年） | - | $陈厉公$、$陈桓公$、@林@ | &陈& |
| 046-003 | 陈完奔齐 | 政治活动 | $宣公$%二十一年% （公元前672年） | - | @陈完@、$齐桓公$ | &陈&、&齐& |
| 046-004 | 田釐子行阴德 | 政治活动 | [约公元前539年] | - | $田釐子乞$、$齐景公$、@晏子@ | &齐& |
| 046-005 | 田乞立阳生 | 政治活动 | （公元前489年） | - | $田乞$、@阳生@、$高昭子$、$国惠子$ | &齐& |
| 046-006 | 田成子弑简公 | 政治活动 | （公元前481年） | =徐州= | $田常$、$简公$、@监止@ | &齐& |
...
- **原文引用**: "其收赋税於民以小*斗*受之，其禀予民以大*斗*，行阴德於民。"
- **段落位置**: [5]
- **年代推断**: 年表前539年明确记载齐景公九年晏婴使晋告叔向'陈氏以家量贷而以公量收之'，即田釐子行阴德之事。当前标注前500年偏晚约40年，应以年表记载为准取约前539年。
...
- **原文引用**: "割&齐&自=安平=以东至=琅邪=，自为封邑。封邑大於$@平公@$之所食。"
- **段落位置**: [8]
- **年代推断**: 年表前476年明确记载'齐平公五年，田常割齐地自安平至琅邪为封邑，比平公自领之地为大'。年表有载应升级为精确纪年（错误模式7：确定性标注不足）。
...
- **原文引用**: "是日，烹$=阿=大夫$，及左右尝誉者皆并烹之。"
- **段落位置**: [13]
- **年代推断**: 年表明确记载齐威王元年=前356年（前357年齐桓公死，子威王立），威王九年=356-(9-1)=前348年。当前前370年系按《史记》田敬仲完世家自身纪年（威王元年=前378年）计算，与年表有22年偏差。年表在前353年条注'齐威王四年'（桂陵之战）、前350年条注'齐威王七年'、前334年条注'齐威王二十三年'，均印证威王元年=前356年。应以年表为准。
...
- **原文引用**: "$@驺忌子@$以鼓*琴*见$@威王@$……居期年，封以=下邳=，号曰$@成侯@$。"
- **段落位置**: [14-15]
- **年代推断**： 驺忌见威王并受相印，年表前356年条载'威王时，用邹忌为相……确年无考'。当前前370年系受046-010锚点错误影响的插值结果。邹忌为相应在威王即位初期（前356年前后），年表虽未给出确切年份但明确关联威王元年条。
...
- **原文引用**: "将以照千里，岂特十二乘哉！"
- **段落位置**: [16]
- **年代推断**: 按年表威王元年=前356年，二十四年=356-(24-1)=前333年。年表前355年条记魏惠王与威王会见同猎，但前334年条记'齐威王二十三年，会徐州相王'，二十四年当为前333年。当前前355年系按《史记》自身纪年（威王元年=前378年）计算。注：此处纪年差异源于田齐世系纪年分歧（《史记》与竹书纪年/年表差22年），但年表为审查ground truth。
...
- **原文引用**: "&齐&=稷下=学士复盛，且数百千人。"
- **段落位置**: [19]
- **年代推断**： 原文说宣王时'稷下学士复盛'。年表前319年条载'齐宣王元年'，宣王在位约前319-前301年。当前前341年系按《史记》纪年的插值结果。稷下复盛当在宣王中期，约前310年为宣王在位中段的合理估计。
...
- **原文引用**: "於是&莒&人共立@法章@，是为$@襄王@$。"
- **段落位置**: [25]
- **年代推断**: 年表前283年明确记载'齐襄王元年。襄王即太子法章，在莒即位'。年表有载应升级为精确纪年（错误模式7：确定性标注不足）。
...
- **自然灾害**: 0
- **经济活动**: 0
- **年代推断**: 年份正确（年表前221年确认秦灭齐），但详情部分缺少'年代推断'字段，应补充。此为格式问题而非年份错误。

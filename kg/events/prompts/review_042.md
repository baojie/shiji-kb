...
你的任务是审查并修正《史记》042_郑世家的事件索引中的年代标注。
...
1. **事件索引**（待审查和修改）：`kg/events/data/042_郑世家_事件索引.md`
...
### 第二步：建立时代框架
本章涉及春秋（郑）时期。
参照 `reign_periods.json` 中相关国家（郑）的国君在位年数据。
春秋：前770年-前476年；战国：前475年-前221年。
年表（`中国历史大事年表.md`）可用于交叉验证关键事件。

### 第三步：读取事件索引
完整读取 `kg/events/data/042_郑世家_事件索引.md`，统计事件总数，识别锚点分布（有多少个精确纪年事件、推断纪年事件、无纪年事件）。
...
- **Claude反思修正**：在 001, 003, 007, 004, 005, 010, 009, 002, 008, 014, 013, 011, 019, 016, 015, 025, 012, 023, 030, 024, 026, 029, 034, 035, 032, 036, 028, 033, 037, 038, 039, 040, 041 中出现
...
- [error] 042-002: 概览=前715年，详情=前722年
- [error] 042-003: 概览=前715年，详情=前722年
- [error] 042-004: 概览=前715年，详情=前722年
- [error] 042-006: 概览=前715年，详情=前722年
- [error] 042-015: 概览=前627年，详情=前659年
...
| 042-002 | 太史伯谋迁雒东 | 政治活动 | [约公元前715年] | =雒=东 | $桓公$、$太史伯$ | &周& |
| 042-003 | 犬戎杀幽王桓公 | 战争 | [约公元前715年] | =骊山= | $幽王$、$桓公$、~犬戎~ | &周& |
| 042-004 | 武公立国 | 继位 | [约公元前715年] | - | @掘突@、$武公$ | &郑& |
| 042-005 | 共叔段之乱 | 战争 | $庄公$%二十二年% （公元前722年） | =京=、=鄢=、=共= | $庄公$、@段@、@武姜@ | &郑& |
| 042-006 | 掘地见母 | 家族事件 | [约公元前715年] | =城颍= | $庄公$、@武姜@、@考叔@ | &郑& |
...
- **段落位置**: [6]
- **年代推断**: 插值：042-005(前722年)→042-007(前707年)
...
| 042-011 | 齐襄公杀子亹 | 政治活动 | - （公元前694年） | =首止= | @子亹@、$齐襄公$、@高渠弥@ | &郑&、&齐& |
| 042-012 | 厉公复入 | 政治活动 | $郑子$%十四年% （公元前680年） | - | $厉公$、@甫假@ | &郑& |
...
- **原文引用**: "%二十二年%，@段@果袭&郑&，@武姜@为内应。$庄公$发兵伐@段@，@段@走。"
- **段落位置**: [5]
- **年代推断**: 年表前722年条明确记载'郑庄公二十二年，弟太叔段谋袭郑'。庄公元年=前743年，二十二年=743-(22-1)=前722年，正确。但需注意：原文年代推断说'原文记载二十二年，即公元前722年'，计算过程正确。
...
- **原文引用**: "母曰：'父一而已，人尽夫也。'女乃告@祭仲@，@祭仲@反杀@雍纠@。"
- **段落位置**: [11]
- **年代推断**: 郑厉公元年为前701年（庄公死年立突）。厉公四年=701-(4-1)=前698年。但年表前697年条记载'厉公欲杀祭仲，谋泄奔蔡。昭公还郑'，此即雍纠事件的结果。前676年是周惠王元年，与厉公四年无关。厉公四年应为前698年，但年表将此事系于前697年，取年表为准。
...
- **原文引用**: "@子亹@至，不谢$齐侯$，$齐侯$怒，遂伏*甲*而杀@子亹@。"
- **段落位置**: [14]
- **年代推断**: 年表前694年条记载'齐襄公出兵谋讨郑弑君之罪'。高渠弥弑昭公后立子亹（子壹），齐襄公杀子亹是在前694年。前679年是厉公复入后的纪年（郑厉公元年），与子亹被杀无关。子亹在位极短。
...
- **原文引用**: "逢&郑&贾人@弦高@诈以十二🌿牛🌿劳军，故&秦&兵不至而还，&晋&败之於=崤=。"
- **段落位置**: [23.1]
- **年代推断**: 年表前627年条明确记载'郑穆公元年。郑商人弦高退秦师于滑'。此处'缪公元年'指郑穆（缪）公元年=前627年。原标注前659年是秦穆公元年，但事件原文'缪公元年'指的是郑缪公（穆公），不是秦缪公。概览表与详情不一致（概览前627年，详情前659年）。
...
- **原文引用**: "&郑&相@子产@卒，&郑&人皆哭泣，悲之如亡亲戚。……@孔子@为泣曰：'古之遗爱也！'"
- **段落位置**: [39]
- **年代推断**: 郑声公元年=前500年（年表前501年'郑献公死，子声公胜立'，声公元年=前500年）。声公五年=500-(5-1)=前496年。但子产卒的公认年份为前522年（年表前522年条有相关记载）。声公五年=前496年不对，因为子产活跃在简公时期（前565-前530），不可能活到声公五年。此处'声公五年'可能是原文记载有误或指另一事件。据学界公认，子产卒于郑定公八年（前522年）。
...
- **建设**: 0
- **经济活动**: 0
- **年代推断**: 年表前375年条明确记载'韩哀侯二年，灭郑，迁都于郑（今河南新郑）'。韩灭郑是战国初期事件（前375年），前480年是春秋末期，差距105年。郑君乙元年约前395年，二十一年=395-(21-1)=前375年。

...
你的任务是审查并修正《史记》117_司马相如列传的事件索引中的年代标注。
...
1. **事件索引**（待审查和修改）：`kg/events/data/117_司马相如列传_事件索引.md`
...
### 第三步：读取事件索引
完整读取 `kg/events/data/117_司马相如列传_事件索引.md`，统计事件总数，识别锚点分布（有多少个精确纪年事件、推断纪年事件、无纪年事件）。
...
|--------|---------|---------|------|------|---------|------|
| 117-001 | 相如少年游梁 | 文化活动 | %孝景帝%时 [约公元前150年] | =梁= | @司马相如@、$梁孝王$ | &汉& |
| 117-002 | 著子虚赋 | 文化活动 | [约公元前148年] | =梁= | @司马相如@ | &汉& |
| 117-003 | 琴挑卓文君 | 家族事件 | [约公元前143年] | =临邛= | @司马相如@、@卓文君@、@卓王孙@ | &汉& |
| 117-004 | 文君当炉卖酒 | 家族事件 | [约公元前143年] | =临邛= | @司马相如@、@卓文君@、@卓王孙@ | &汉& |
| 117-005 | 天子读子虚赋召见 | 文化活动 | [约公元前138年] | - | @司马相如@、@杨得意@ | &汉& |
| 117-006 | 作天子游猎赋 | 文化活动 | [约公元前138年] | - | @司马相如@ | &汉& |
| 117-007 | 喻巴蜀檄文 | 政治活动 | [约公元前130年] | =巴蜀= | @司马相如@、@唐蒙@ | &汉& |
| 117-008 | 通西南夷为中郎将 | 政治活动 | [约公元前129年] | =邛=、=筰=、=厓=、=駹= | @司马相如@、@王然于@ | &汉& |
| 117-009 | 难蜀父老 | 文化活动 | [约公元前129年] | =蜀= | @司马相如@ | &汉& |
...
- **段落位置**: [0]
- **年代推断**: 梁孝王来朝在景帝前七年（前150年），据《中国历史大事年表》
...
- **段落位置**: [1]
- **年代推断**: 梁孝王卒于前144年，年表载前143年"司马相如游临邛"
...
- **段落位置**: [2]
- **年代推断**: 武帝即位后（前141年），约建元三年（前138年）前后召见
...
- **段落位置**: [4]
- **年代推断**: 元光五年（前130年），年表载唐蒙通夜郎、武帝遣相如责唐蒙喻蜀人
...
- **段落位置**: [5]
- **年代推断**: 元光六年（前129年），年表载"以司马相如为中郎将，建节为使，置县十余"
...
- **段落位置**: [15]
- **年代推断**: 汉武帝封禅泰山在元封元年（前110年），交叉验证年表修正

...
你的任务是审查并修正《史记》078_春申君列传的事件索引中的年代标注。
...
1. **事件索引**（待审查和修改）：`kg/events/data/078_春申君列传_事件索引.md`
...
### 第三步：读取事件索引
完整读取 `kg/events/data/078_春申君列传_事件索引.md`，统计事件总数，识别锚点分布（有多少个精确纪年事件、推断纪年事件、无纪年事件）。
...
| 078-003 | 黄歇护送太子完归楚 | 政治活动 | [约公元前263年] | =秦=、=楚= | @黄歇@、=楚=太子完、应侯 | &战国& |
...
| 078-008 | 春申君北伐灭鲁 | 战争 | [公元前255年] | =鲁= | @春申君@、@荀卿@ | &战国& |
...
- **段落位置**：[11]
- **年代推断**：顷襄王元年=前298年，在位三十六年，病重当在末年。考烈王元年=前262年，太子归楚在前一年，即前263年
...
- **段落位置**：[14]
- **年代推断**：考烈王元年=前262年，相楚八年=前255年。年表载前256年"楚考烈王七年，灭鲁"，有一年之差，从本传"相楚八年"推算取前255年
...
- **原文引用**：@春申君@相=楚=八年，为=楚=北伐灭=鲁=，以@荀卿@为兰陵令。当是时，=楚=复彊。
- **段落位置**：[14]
- **年代推断**： 年表前256年条明确记载'楚考烈王七年，灭鲁，迁封鲁君于莒'。考烈王元年=前262年，七年=262-(7-1)=256年，与年表吻合。原标注采用本传'相楚八年'推算为前255年，与年表差一年。'相楚八年'与'考烈王七年'的一年差异可能因拜相在元年年中导致纪年错位，应以年表明确记载为准

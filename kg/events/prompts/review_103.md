...
你的任务是审查并修正《史记》103_万石张叔列传的事件索引中的年代标注。
...
1. **事件索引**（待审查和修改）：`kg/events/data/103_万石张叔列传_事件索引.md`
...
### 第三步：读取事件索引
完整读取 `kg/events/data/103_万石张叔列传_事件索引.md`，统计事件总数，识别锚点分布（有多少个精确纪年事件、推断纪年事件、无纪年事件）。
...
|--------|---------|---------|------|------|---------|------|
| 103-001 | 石奋入仕高祖 | 政治活动 | @高祖@击@项籍@时 [约公元前205年] | =河内= | @石奋@、@高祖@ | &汉& |
| 103-002 | 石奋为太子太傅 | 政治活动 | $文帝$时 [约公元前170年] | - | @石奋@、@文帝@ | &汉& |
| 103-003 | 万石君号由来 | 政治活动 | $景帝$时 [约公元前150年] | - | @石奋@、@石建@、@石甲@、@石乙@、@石庆@、$景帝$ | &汉& |
| 103-004 | 万石君家风教子 | 家族事件 | $景帝$晚年 [约公元前143年] | - | @万石君@ | &汉& |
...
| 103-013 | 卫绾击吴楚封建陵侯 | 战争 | $孝景$前%六年% | - | @卫绾@ | &汉& |
...
| 103-018 | 张欧以诚长者处官 | 政治活动 | $武帝$%元朔四年% （公元前125年） | - | @张欧@ | &汉& |
...
- **段落位置**: [1.1]
- **年代推断**: 高祖东击项籍过河内，约在前205年楚汉战争期间；石奋年十五（生约前219年）亦合
...
- **段落位置**: [3.3]—[3.4]
- **年代推断**: 据《中国历史大事年表》，景帝后元年(前143年)以卫绾为丞相
...
| 103-016 | 直不疑击吴楚封塞侯 | 战争 | $景帝$後元年 （公元前143年） | - | @直不疑@ | &汉& |
| 103-017 | 周仁阴重得幸景帝 | 政治活动 | $景帝$时 [约公元前150年] | - | @周仁@ | &汉& |
| 103-018 | 张欧以诚长者处官 | 政治活动 | $武帝$%元朔四年% （公元前131年） | - | @张欧@ | &汉& |
...
- **原文引用**: "@高祖@与语，爱其恭敬""以@奋@为$中涓$，受书谒，徙其家=长安=中=戚里="
- **段落位置**: [1.1]
- **年代推断**: 高祖击项籍过河内在汉王二年(前205年)，年表前205年条记载汉王东进、破殷及河内郡事，时间确定，可从'约'升级为确定推算
...
- **原文引用**: "&吴&&楚&反，诏@绾@为将，将=河间=兵击&吴&&楚&有功，拜为$中尉$。%三岁%，以军功，@孝景@前%六年%中封@绾@为$建陵侯$。"
- **段落位置**: [3.2]
- **年代推断**: 景帝前六年=156-(6-1)=前151年，换算正确。但事件实际包含两个时间点：击吴楚在前154年（七国之乱），封建陵侯在前151年（前六年）。原文'三岁，以军功，孝景前六年中封绾为建陵侯'明确表明封侯年为前151年，当前标注以封侯年为准，合理。确认无误
...
- **原文引用**: "自@欧@为吏，未尝言案人，专以诚长者处官。""上具狱事，有可卻，卻之；不可者，不得已，为涕泣面对而封之。其爱人如此。"
- **段落位置**: [6.1]
- **年代推断**: 年表前131年（元光四年）明确记载'中尉张欧为御史大夫'，与韩安国以病免同在前131年。事件索引称%元朔四年%（前125年），与年表不符。年表前125年（元朔四年）无张欧相关记载。据年表，张欧拜御史大夫应为前131年（元光四年），原文%元朔四年%可能为传抄讹误或原文误记

...
你的任务是审查并修正《史记》130_太史公自序的事件索引中的年代标注。

## 背景

此前已修正13个因锚点污染而错误的事件。请验证并查找遗漏。

## 输入文件

1. **事件索引**（待审查和修改）：`kg/events/data/130_太史公自序_事件索引.md`
...
### 第二步：建立时代框架
本章为通论性质（太史公自序），时间跨度可能从远古到汉武帝，横跨多个时代。
**重点检查**：
...
### 第三步：读取事件索引
完整读取 `kg/events/data/130_太史公自序_事件索引.md`，统计事件总数，识别锚点分布（有多少个精确纪年事件、推断纪年事件、无纪年事件）。
...
- [warning] 130-001: '颛顼命重黎司天地'标注前2476年，离群于本章核心范围前621年~前96年
...
| 130-005 | 司马错伐蜀守之 | 战争 | [约公元前342年] | &蜀& | @错@、@张仪@ | &秦& |
| 130-006 | 司马靳与白起赐死 | 战争 | [约公元前295年] | =杜邮=、=华池= | @靳@、@白起@ | &秦& |
| 130-007 | 司马昌为秦主铁官 | 家族事件 | [约公元前220年] | - | @昌@ | &秦& |
| 130-008 | 司马卬王殷归汉 | 政治活动 | [约公元前205年] | =朝歌= | @卬@ | &汉& |
...
| 130-013 | 司马谈临终嘱托 | 家族事件 | [约公元前110年] | =河洛= | @谈@、@迁@ | &汉& |
| 130-014 | 司马迁继任太史令 | 政治活动 | [约公元前108年] | - | @迁@ | &汉& |
| 130-015 | 太初改历建明堂 | 政治改革 | %太初元年% （公元前104年） | =明堂= | @迁@ | &汉& |
| 130-016 | 司马迁自比孔子 | 文化活动 | [约公元前104年] | - | @迁@ | &汉& |
| 130-017 | 与壶遂论春秋 | 文化活动 | [约公元前104年] | - | @迁@、@壶遂@ | &汉& |
| 130-018 | 李陵之祸幽于缧绁 | 政治活动 | [约公元前99年] | - | @迁@、@李陵@ | &汉& |
...
- **段落位置**: [1.2]
- **年代推断**: "惠襄之间"指周惠王至周襄王间（前676-前619年）；随会奔秦在前621年（鲁文公六年），取此年为锚点
...
- **段落位置**: [1.3]
- **年代推断**: 插值前104年与人物生卒年冲突，改用人物交集中点：张仪(前373年~前310年)，中点前342年
...
- **段落位置**: [1.4]
- **年代推断**: 插值前104年与人物生卒年冲突，改用人物交集中点：白起(前332年~前257年)，中点前295年
...
- **段落位置**: [1.4]
- **年代推断**: 项羽分封诸侯王在前206年，"汉之伐楚卬归汉"在前205年汉二年
...
- **段落位置**: [11.1]-[11.5]
- **年代推断**: 武帝封禅泰山在元封元年（前110年），司马谈留滞周南不得从行，发愤而卒
...
- **段落位置**: [12.1]
- **年代推断**: 原文"卒三岁而迁为太史令"，司马谈卒于前110年，三年后即前108年（或前107年）
...
- **段落位置**: [19.1]
- **年代推断**: 李陵之祸在天汉二年（前99年），原文"七年"从太初元年（前104年）算起亦合
...
| 130-001 | 颛顼命重黎司天地 | 政治活动 | [约公元前2476年] | - | @颛顼@、@重@、@黎@ | &唐虞& |
| 130-002 | 程伯休甫为周司马 | 家族事件 | [约公元前805年] | - | @程伯休甫@ | &周& |
| 130-003 | 司马氏去周适晋 | 家族事件 | [约公元前620年] | =少梁= | @司马@氏、@随会@ | &周& |
| 130-004 | 司马氏分散各国 | 家族事件 | [约公元前400年] | - | @司马@氏 | &周& |
...
- **原文引用**: "@惠@、@襄@之间，@司马@氏去&周&適&晋&。&晋&$中军$@随会@奔&秦&，而@司马@氏入=少梁=。"
- **段落位置**: [1.2]
- **年代推断**: 年表前620年（鲁文公七年）条记载'先蒐、士会奔秦'，非前621年（鲁文公六年）。前621年是赵盾遣士会赴秦迎公子雍，前620年士会才因故奔秦。原推断理由'随会奔秦在前621年（鲁文公六年）'有误

...
**近期里程碑**（2026-04-19 ～ 04-22）：
- **白话翻译 130 章全库落地** + **三家注（集解/索隐/正义）行下展示**（[#13](https://github.com/baojie/shiji-kb/issues/13) / [#16](https://github.com/baojie/shiji-kb/issues/16) 已关闭）
- **别名模糊搜索** + 搜索系统 SPEC 化（[#41](https://github.com/baojie/shiji-kb/issues/41) 进展）
- **实体分类反思收敛**：人名 1832→3682 人、官职 18→21 类 + 级别分类、地名七轮反思、邦国 11 类首轮 100% 落地
- **修辞标注层 `〘※〙`**（成语等）首次引入 + 成语识别工作流双轨数据架构
- **OCR 影印古籍句读排版工序**（[SKILL_01i](skills/SKILL_01i_OCR影印古籍句读排版.md)）：以《读史记十表》为首例
...
- → **[SKILL_00_管线总览](skills/SKILL_00_管线总览.md)** | **[完整SKILL索引](skills/INDEX.md)**
...
- 注：当前SKILL体系已扩展至104个（14元技能 + 90管线技能），PDF为2026-03-19版本快照
...
| **方法论** | 14 元技能 + 90 管线技能 | 2 本 PDF 合集（共 863 页，2026-03 快照） |
...
详见：[管线总览](skills/SKILL_00_管线总览.md) | [完整SKILL索引](skills/INDEX.md)

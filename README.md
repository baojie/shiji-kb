...
- 🔗 **实体索引**：11类实体索引页面（9,700+条目），正文实体可点击跳转，别名合并，拼音排序导航
...
| **实体索引** | 11/11 (100%) ✅ | 11类实体索引页面，正文实体可点击跳转，别名合并，拼音排序 |
...
- 🔗 **命名实体索引系统**：11类实体索引页面（9,700+条目），正文实体可点击跳转到索引条目，别名合并（~200条），拼音排序导航

...
| 迭代速度 | 数周一轮 | 数小时一轮 |
| 核心瓶颈 | **2001: 设计** | **2026: 策展** |

**核心转变**：2001年的难点是"设计本体"，2026年的难点是"策展AI提取的本体"。本体不再是专家预先设计的蓝图，而是从数据中生长出来、由人类修剪和校准的有机结构。
...
**项目维护者**：[baojie](https://github.com/baojie) · **最后更新**：2026-03-19

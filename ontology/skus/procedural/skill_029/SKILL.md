...
1. **Survey the terrain**: Identify nearby rivers or water sources that can be diverted
2. **Plan diversion routes**: Construct canals or channels (河沟) to direct water toward the target city
3. **Execute diversion**: Breach or redirect water flow toward city walls
4. **Monitor effects**: Wait for water pressure to compromise walls and foundations
5. **Accept surrender**: Once walls collapse, the defending ruler will typically surrender
6. **Secure territory**: Take control of the entire region

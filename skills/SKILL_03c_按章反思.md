...
>
> **规律库拆分**：2026-03-21，§三已积累的错误模式（67条规律）拆分到独立文件 [`references/SKILL-03c-rules.md`](references/SKILL-03c-rules.md)
...
1. **读取规律库**：读取 `skills/references/SKILL-03c-rules.md` 全文，了解所有已知错误模式（67条规律）
   - 可按需读取特定类别：A(类型判断60条)/B(邦国氏族3条)/C(单字消歧4条)

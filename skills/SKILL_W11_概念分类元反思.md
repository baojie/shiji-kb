...
输出日志写入 `logs/wiki_butler/type_audits/YYYY-MM-DD-R<N>.md`。
...
写入 `logs/wiki_butler/type_audits/YYYY-MM-DD-R<N>.md`，格式：
...
- 新发现的概念候选加入 `logs/wiki_butler/queue.md` P1 段
...
W11 审计确认某分类规则后，将定论写入 `logs/wiki_butler/kb/w11_taxonomy.md`：

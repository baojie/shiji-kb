...
| 03d | [SKILL_03d_渲染与发布.md](SKILL_03d_渲染与发布.md) | 渲染与发布（衔接SKILL 09a） |
...
| 编号 | 文件 | 说明 |
|------|------|------|
| 06 | [SKILL_06_本体构建.md](SKILL_06_本体构建.md) | 阶段总览 |
...
| 09a | [SKILL_09a_认知辅助阅读器.md](SKILL_09a_认知辅助阅读器.md) | 语法高亮渲染 + 实体配色 + 段落锚点 + 发布 |

...
1. **[大规模知识库构造元技能方法论](publications/meta-skill-book/大规模知识库构造元技能方法论.pdf)**
   - 发布日期：2026-03-18，425页，2.35MB，包含14个元技能
   - OTF+JIT+Bootstrap、反思循环、冷启动、柳叶刀方法等
   - 通用知识工程方法论，可迁移到任何领域

2. **[史记知识库构造管线技能手册](publications/pipeline-skills-book/史记知识库构造管线技能手册.pdf)**
   - 发布日期：2026-03-19，438页，3.01MB，包含40个管线SKILL
   - 校勘→结构分析→实体构建→事件构建→关系构建→本体构建→逻辑推理→知识库管驭→应用
   - 古籍处理完整技术栈（当前SKILL体系已扩展至77个）

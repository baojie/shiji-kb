...
| 手册 | 发布日期 | 页数 | 大小 | 内容 | 目录 |
|------|---------|------|------|------|------|
| [大规模知识库构造元技能方法论](meta-skill-book/) | 2026-03-18 | 425页 | 2.35MB | 14个通用元技能方法论 | [查看](meta-skill-book/) |
| [史记知识库构造管线技能手册](pipeline-skills-book/) | 2026-03-19 | 438页 | 3.01MB | 40个管线SKILL（当前已扩展至77个） | [查看](pipeline-skills-book/) |
...
```
publications/
├── meta-skill-book/        # 元技能方法论PDF（2026-03-18，425页，2.35MB，14个元技能）
│   ├── 大规模知识库构造元技能方法论.pdf
│   ├── 大规模知识库构造元技能方法论.html
...
│   └── README.md
│
├── pipeline-skills-book/   # 管线技能手册PDF（2026-03-19，438页，3.01MB，40个SKILL）
│   ├── 史记知识库构造管线技能手册.pdf
│   ├── 史记知识库构造管线技能手册.html
